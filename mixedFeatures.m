function [features]=sophisticatedFeatures(data, av_per_dif, std_per_dif, symmetric_av, symmetric_std, neigh_av_cut_per, neigh_std_cut_per )
...
basic_features3D=[average3D standard_dev3D max_av_difference3D max_std_difference3D symmetric_av_difference3D symmetric_std_difference3D];
...
features=[basic_features neigh_av_cut_dif neigh_std_cut_dif];
