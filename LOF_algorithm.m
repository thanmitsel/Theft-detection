...
[train_idx, test_idx]=crossvalind('HoldOut', z, 0.5);
Train_X=Z(train_idx,:);
Train_Y=Y(train_idx,1);
Test_X=Z(test_idx,:);
Test_Y=Y(test_idx,1);
save tvx.mat Train_X;
save tvy.mat Train_Y;
save tsx.mat Test_X;
save tsy.mat Test_Y;
dataset = ReadDataset(path);
results = LocalOutlierFactor(dataset, params);
prediction=results.y-1;

[precision,recall, in_recall, accuracy,F1score] = confusionMatrix (Test_Y, prediction);
...
delete tsx.mat tsy.mat tvx.mat tvy.mat