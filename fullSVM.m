...
pred_ID=(sum(pred_table==1)>20)'; % fraud if more than 20 days

% Create confusion Matrix
[precision, recall, accuracy, F1score] = confusionMatrix (Y_test, prediction);
[precision_t, recall_t, accuracy_t, F1score_t] = confusionMatrix (class_ID, pred_ID);
